                            ...
                            <TR>
                                ...
                                <TD>
                                    <TABLE cellSpacing=0 cellPadding=2 border=0>
                                        ...
                                        <TR>
                                            <TD style="HEIGHT: 18px" colspan="2"><font color="red">${exception.message} </font></TD>
                                        ...
                                        <TR>
                                            ...
                                            <TD>
                                                <img style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px;cursor: pointer" src="images/regist_button.png"
