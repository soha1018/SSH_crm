											...
											<TBODY>
												<TR>
													...
													<TD>
														...
														<INPUT class=textbox style="WIDTH: 80px" maxLength=50 name="cust_name"  id="cust_name" value="${param['cust_name']}" onmousedown="window.open('${pageContext.request.contextPath}/CustomerAction_list?select=true','','width=600,height=300')" >
