                                ...
                                <TD>
                                    <TABLE cellSpacing=0 cellPadding=2 border=0>
                                        ...
                                        <TR>
                                            <TD></TD>
                                            <TD>
                                                <INPUT style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px;cursor: pointer"
                                                       type=image src="images/regist_button.png">
                                            </TD>
                                        </TR>
                                        </TBODY>
                                    </TABLE>
